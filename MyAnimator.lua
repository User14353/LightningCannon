...
local function C_c()
	...
	addmode("f", {
		...
		fall = function()
			...
			local SongLinks = {
				["gunless"] = "https://raw.githubusercontent.com/bayly098764321/Hat-FE/main/GunAway",
				["gun"]     = "https://raw.githubusercontent.com/bayly098764321/Hat-FE/main/GunOut",
			}
